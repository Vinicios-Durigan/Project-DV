...
- Baixar os `.ttf` OFL das duas fontes e registrar no tema — fazer quando
  houver conexão, sem bloquear a wave.
- O diário colapsável começa aberto ou fechado? Decidir jogando.
- Tremida de tela: intensidade a calibrar na mão — começar sutil.
