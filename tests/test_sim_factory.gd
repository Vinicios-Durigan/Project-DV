...
func test_monta_os_dez_sistemas_na_ordem_fixa() -> void:
	...
	assert_true(_sistema(6) is SistemaOficios, "7. Ofícios aprende do mesmo golpe que cansou")
	assert_true(_sistema(7) is SistemaCidade, "8. Cidade age com a colheita já na mochila")
	assert_true(_sistema(8) is SistemaContratos, "9. Contratos, o degrau seguinte da cidade")
	assert_true(_sistema(9) is TimeSystem, "10. Time vira o calendário por último")
